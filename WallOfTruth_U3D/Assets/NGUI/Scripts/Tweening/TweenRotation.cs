...
public class TweenRotation : UITweener
{
    ...
    {
        get { return worldSpace ? cachedTransform.rotation : cachedTransform.localRotation; }
        set
        {
            if (worldSpace)
    ...
    {
        return Begin(go, duration, rot, false);
    }
    ...
    static public TweenRotation Begin(GameObject go, float duration, Quaternion rot, bool worldSpace)
    {
